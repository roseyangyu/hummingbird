...
void GazeboRosRealsense::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  this->color_pub_ = this->itnode_->advertiseCamera("camera/color/image_rect_raw", 2);
  this->ir1_pub_ = this->itnode_->advertiseCamera("camera/ir1/image_rect_raw", 2);
  this->ir2_pub_ = this->itnode_->advertiseCamera("camera/ir2/image_rect_raw", 2);
